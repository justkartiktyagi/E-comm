          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 container mx-auto pt-10 md:pt- h-full w-full ">
            ...
            <div className=" flex items-center align-middle pl-20 mt-10 md:mt-0 md:pl-0 justify-center">
              <img
                ...
                src="/There’s no denying that the Nike Dunk, both high and low, is on track to become the hottest sneaker of the year — again_ Known for its relatively thick silhouette and coveted colorways, the iconic shoe has undoubtedly.png"
                alt=""
                srcset=""
              />
            </div>
